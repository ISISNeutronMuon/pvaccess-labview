...
<Library LVVersion="20008000">
	...
	<Item Name="Value Pointer" Type="Folder">
		<Item Name="Create Value.vi" Type="VI" URL="../Create Value.vi"/>
		<Item Name="Get Value Internal.vim" Type="VI" URL="../Get Value Internal.vim">
			<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		</Item>
		<Item Name="Get Value Variant.vi" Type="VI" URL="../Get Value Variant.vi"/>
		<Item Name="Get Value.vim" Type="VI" URL="../Get Value.vim"/>
		<Item Name="Set Value Internal.vim" Type="VI" URL="../Set Value Internal.vim">
			<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		</Item>
		<Item Name="Set Value Variant.vi" Type="VI" URL="../Set Value Variant.vi"/>
		<Item Name="Set Value.vim" Type="VI" URL="../Set Value.vim"/>
	</Item>
	<Item Name="Variant Utilities" Type="Folder">
		<Property Name="NI.LibItem.Scope" Type="Int">2</Property>
		<Item Name="Default Variant.vi" Type="VI" URL="../Default Variant.vi"/>
		<Item Name="Get Type Code.vi" Type="VI" URL="../Get Type Code.vi"/>
